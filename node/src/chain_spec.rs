...
use carambola_runtime::BeefyConfig;
use carambola_runtime::{
	opaque::SessionKeys, Balance, ImOnlineConfig, SessionConfig, DOLLARS,
};
use carambola_runtime::{OctopusAppchainConfig, OctopusLposConfig};
...
fn testnet_genesis(
	...
	GenesisConfig {
		...
		babe: BabeConfig {
			authorities: vec![],
			epoch_config: Some(carambola_runtime::BABE_GENESIS_EPOCH_CONFIG),
		},
